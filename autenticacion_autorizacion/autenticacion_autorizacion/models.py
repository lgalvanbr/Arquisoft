...
class AuditoriaAcceso(models.Model):
    ...
    username = models.CharField(max_length=150)  # Para registrar intentos incluso si el usuario no existe
...
class IntentoBloqueado(models.Model):
    ...
    activo = models.BooleanField(default=True)
    duracion_bloqueo_segundos = models.IntegerField(default=300)  # 5 minutos por defecto
...
class RolPermiso(models.Model):
    ...
    """
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    rol = models.CharField(max_length=50)  # admin, usuario, gerente
